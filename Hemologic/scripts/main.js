...
function main (time) {
    ...
    draw.fillText('Quadtree: ' + useQuadtree + ';', 24, 'left', new Vector(10, 30 * spacing)); spacing++;
    draw.fillText('Culling: ' + useCulling + ';', 24, 'left', new Vector(10, 30 * spacing)); spacing++;
    draw.fillText('Type: ' + spawnType + ';', 24, 'left', new Vector(10, 30 * spacing)); spacing++;
    draw.fillText('White Cell: ' + whiteCount + ';', 24, 'left', new Vector(10, 30 * spacing)); spacing++;
    draw.fillText('Red Cell: ' + bloodCount + ';', 24, 'left', new Vector(10, 30 * spacing)); spacing++;
    if(bacteriaCount > 0) {
        draw.fillText('Bacteria: ' + bacteriaCount + ';', 24, 'left', new Vector(10, 30 * spacing)); spacing++;
        draw.fillText('Response: ' + Math.floor(immunoResponse*2/bacteriaCount*100) + '%' + ';', 24, 'left', new Vector(10, 30 * spacing)); spacing++;
    };
    if(paused) {
